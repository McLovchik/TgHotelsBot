...
async def add_new_favorite(user: dict, collection: motor.motor_asyncio.AsyncIOMotorCollection, message: Message):
...
async def add_first_favorite(collection: motor.motor_asyncio.AsyncIOMotorCollection, message: Message):
