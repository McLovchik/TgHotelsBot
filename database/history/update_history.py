...
async def add_new_to_history(user: dict, collection: motor.motor_asyncio.AsyncIOMotorCollection, command: str, call_time: str,
                             message: Message):
...
async def create_history(collection: motor.motor_asyncio.AsyncIOMotorCollection, command: str, call_time: str, message: Message):
...
def create_history_dict(command: str, call_time: str) -> dict:
    ...
    history_dict = {
        'text': f'<b>Command</b> /{command} called\n'
